...
//  DEPLOYED ADDRESSES  (v5 self-marking hook)

export const SEPOLIA_CHAIN_ID = 11155111

// Block the hook was deployed at - the floor for any full-history log scan
// (e.g. recovering a position's pool from PoolManager ModifyLiquidity events).
// Keep in sync with api/og.js + api/index-events.js.
export const DEPLOY_BLOCK = 11239703n

export const ADDR = {
  // Sepolia - v5 fresh deployment (45 pairs, self-marking hook)
...
export const HOOK_ABI = parseAbi([
  ...
  // writes
  'function depositILBond(PoolKey key, int24 tickLower, int24 tickUpper, uint128 liquidityAmount, uint256 amount0Max, uint256 amount1Max, uint256 askPremium) payable returns (uint256 positionId)',
  'function buyILBond(uint256 positionId) payable',
  ...
  'function collectFees(uint256 positionId) returns (uint256 fee0, uint256 fee1)',
  ...
  'function ilMark(uint256 positionId) view returns (int256 ilBps, uint256 markValue)',
  'function computeILMark(uint160 entrySqrtPriceX96, uint160 currentSqrtPriceX96, uint128 liquidity) pure returns (int256 ilBps, uint256 markValue)',
  'function markTick(bytes32 poolId) view returns (int24)',
  'function markSqrtPriceX96(bytes32 poolId) view returns (uint160)',
  'function quotePremium(PoolKey key, int24 tickLower, int24 tickUpper, uint128 liquidity) view returns (uint256 premium)',
  'function activePositionCount() view returns (uint256)',
  'function activePositionIds(uint256 index) view returns (uint256)',
  ...
  'function poolFeeState(bytes32 poolId) view returns (int24 lastTick, uint256 volEwma, bool initialized, int256 markTickX6)',
  // events
